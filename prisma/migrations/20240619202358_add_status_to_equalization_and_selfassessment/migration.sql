...
INSERT INTO "new_Equalization" ("cycleId", "date", "evaluatedId", "evaluatorId", "finalGrade", "id") SELECT "cycleId", "date", "evaluatedId", "evaluatorId", "finalGrade", "id" FROM "Equalization";
